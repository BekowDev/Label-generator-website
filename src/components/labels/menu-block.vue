        ...
        <div class="flex flex-col gap-2 bg-white rounded-[10px] p-5 menu__item">
            <div class="flex gap-2 flex-col">
                <div class="flex gap-2">
                    ...
                    <button
                        class="underline flex items-center text-[#5856d6]"
                ...
                >
                    ...
                    <button
                        ...
                        class="text-[14px] bg-[#5856d6] text-white px-3 rounded-[10px]"
                    >{{ $t('saveL') }}</button>
                </div>
            </div>
            <div class="text-center">
                <button
                    class="underline flex items-center text-[#FE805D]"
                    @click="deleteUser"
                >
                    {{ $t('deleteAccount') }}
                </button>
            </div>
            <auth-button @click="$store.commit('exitAccount')">
                {{ $t('leaveAccount') }}
            </auth-button>
        </div>
    </div>
