            ...
            <tr>
                ...
                <td class="px-2 w-[7%]">
                    <div class="w-full flex gap-2 justify-center">
                        Дата
                        <img
                            src="data:image/png;base64,"
                            class="w-[14px]"
        ...
        <tbody class="text-[14px] leading-3">
            ...
            >
                ...
                >
                    ...
                    <td class="px-2">{{ !label.brand ? "——————" : label.brand }} <br> {{ !label.seller ? "——————" :
                        label.seller
                    }}</td>
                    <td class="px-2">{{ !label.size ? "——————" : label.size }}</td>
                    <td class="px-2">{{ !label.color ? "——————" : label.color }}</td>
                    <td class="px-2">{{ !label.addedDate ? "——————" : label.addedDate.slice(0, label.addedDate.indexOf("T"))
                    }}
                    </td>
                    <td class="px-2">
                        <div class="flex justify-between">
                            <button
                                class="border-[1px] rounded-full p-[10px]"
                            ...
                            <button
                                class="border-[1px] rounded-full p-[10px]"
                                @click="$store.dispatch('deleteLabel', label._id), $store.dispatch('getLabels')"
                            >
                                <svg
                                    fill="none"
                                    height="15"
